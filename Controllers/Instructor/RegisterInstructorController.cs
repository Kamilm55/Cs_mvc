...
public class RegisterInstructorController : Controller
{
    ...
    private readonly ILogger<LoginController> _logger;
        ...
        public RegisterInstructorController(ILogger<LoginController> logger,IUserRepository userRepository , ApplicationDbContext dbContext)
        {
        ...
        public IActionResult Index(RegisterDTO registerDto)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    _userRepository.CreateInstructor(registerDto);
                    ...
                    if (createdUser!=null)
                    {
                        ...
                        return RedirectToAction("Index", "HomeInstructor");
                    }
