...
public class LoginInstructorController : Controller
{
    ...
    public LoginInstructorController(ILogger<LoginController> logger,IUserRepository userRepository)
    {
    ...
    public IActionResult Index(LoginDTO loginDto)
    {
        ...
        try
        {
            if (ModelState.IsValid)
            {
                ...
                User authenticatedUser = _userRepository.ValidateInstructor(loginDto);
